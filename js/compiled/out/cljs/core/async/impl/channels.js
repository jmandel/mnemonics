...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16527 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16527 = (function (val,box,meta16528){
this.val = val;
this.box = box;
this.meta16528 = meta16528;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t16527.cljs$lang$type = true;
cljs.core.async.impl.channels.t16527.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16527";
cljs.core.async.impl.channels.t16527.cljs$lang$ctorPrWriter = (function (this__8617__auto__,writer__8618__auto__,opt__8619__auto__){return cljs.core._write.call(null,writer__8618__auto__,"cljs.core.async.impl.channels/t16527");
});
cljs.core.async.impl.channels.t16527.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16527.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16529){var self__ = this;
var _16529__$1 = this;return self__.meta16528;
});
cljs.core.async.impl.channels.t16527.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16529,meta16528__$1){var self__ = this;
var _16529__$1 = this;return (new cljs.core.async.impl.channels.t16527(self__.val,self__.box,meta16528__$1));
});
cljs.core.async.impl.channels.__GT_t16527 = (function __GT_t16527(val__$1,box__$1,meta16528){return (new cljs.core.async.impl.channels.t16527(val__$1,box__$1,meta16528));
});
}
return (new cljs.core.async.impl.channels.t16527(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8620__auto__,writer__8621__auto__,opts__8622__auto__){return cljs.core._write.call(null,writer__8621__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8617__auto__,writer__8618__auto__,opt__8619__auto__){return cljs.core._write.call(null,writer__8618__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_16530 = self__.takes.pop();if((taker_16530 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16530))
{var take_cb_16531 = cljs.core.async.impl.protocols.commit.call(null,taker_16530);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16531,taker_16530,this$__$1){
return (function (){return take_cb_16531.call(null,null);
});})(take_cb_16531,taker_16530,this$__$1))
);
} else
{}
{
