...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16521 = (0);while(true){
var m_16522 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16522 == null))
{} else
{m_16522.call(null);
if((count_16521 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16523 = (count_16521 + (1));
count_16521 = G__16523;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__8029__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__8029__auto__)
