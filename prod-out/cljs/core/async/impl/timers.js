...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_26045 = (0);while(true){
...
{var i_26058 = (self__.level + (1));while(true){
if((i_26058 <= (new_level + (1))))
{(update[i_26058] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_26060 = (0);while(true){
if((i_26060 <= self__.level))
{var links_26061 = (update[i_26060]).forward;if(((links_26061[i_26060]) === x__$1))
{(links_26061[i_26060] = (x__$1.forward[i_26060]));
{
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3639__auto__,timeout__$1,me){
