...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4245__auto__,writer__4246__auto__,opt__4247__auto__){return cljs.core._write(writer__4246__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_26060 = (0);while(true){
if((i_26060 < arr.length))
{(arr[i_26060] = null);
{
var G__26061 = (i_26060 + (1));
i_26060 = G__26061;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4245__auto__,writer__4246__auto__,opt__4247__auto__){return cljs.core._write(writer__4246__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_26073 = (self__.level + (1));while(true){
if((i_26073 <= (new_level + (1))))
{(update[i_26073] = self__.header);
{
var G__26074 = (i_26073 + (1));
i_26073 = G__26074;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_26075 = (0);while(true){
if((i_26075 <= self__.level))
{var links_26076 = (update[i_26075]).forward;if(((links_26076[i_26075]) === x__$1))
{(links_26076[i_26075] = (x__$1.forward[i_26075]));
{
var G__26077 = (i_26075 + (1));
i_26075 = G__26077;
continue;
}
} else
{{
var G__26078 = (i_26075 + (1));
i_26075 = G__26078;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3669__auto__ = (cljs.core.truth_((function (){var and__3657__auto__ = me;if(cljs.core.truth_(and__3657__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3657__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3669__auto__))
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3669__auto__,timeout__$1,me){
...
});})(timeout_channel,or__3669__auto__,timeout__$1,me))
,msecs);
