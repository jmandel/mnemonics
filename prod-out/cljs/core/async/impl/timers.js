...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4245__auto__,writer__4246__auto__,opt__4247__auto__){return cljs.core._write.call(null,writer__4246__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_15221 = (0);while(true){
if((i_15221 < arr.length))
{(arr[i_15221] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4245__auto__,writer__4246__auto__,opt__4247__auto__){return cljs.core._write.call(null,writer__4246__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_15228 = (self__.level + (1));while(true){
if((i_15228 <= (new_level + (1))))
{(update[i_15228] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15230 = (0);while(true){
if((i_15230 <= self__.level))
{var links_15231 = (update[i_15230]).forward;if(((links_15231[i_15230]) === x__$1))
{(links_15231[i_15230] = (x__$1.forward[i_15230]));
{
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__3669__auto__,timeout__$1,me){
