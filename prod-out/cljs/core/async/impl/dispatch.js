...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15314 = (0);while(true){
var m_15315 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15315 == null))
{} else
{m_15315.call(null);
if((count_15314 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15316 = (count_15314 + (1));
count_15314 = G__15316;
continue;
}
} else
{}
