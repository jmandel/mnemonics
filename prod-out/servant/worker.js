...
*/
servant.worker.post_array_buffer = (function post_array_buffer(p__12079){var vec__12081 = p__12079;var result = cljs.core.nth.call(null,vec__12081,(0),null);var arraybuffers = cljs.core.nth.call(null,vec__12081,(1),null);return self.postMessage(result,cljs.core.clj__GT_js.call(null,arraybuffers));
});
servant.worker.decode_message = (function decode_message(event){var pred__12085 = cljs.core._EQ_;var expr__12086 = (event.data["command"]);if(cljs.core.truth_(pred__12085.call(null,"channel",expr__12086)))
{return self.postMessage(servant.worker.run_function_name.call(null,event.data));
} else
{if(cljs.core.truth_(pred__12085.call(null,"channel-arraybuffer",expr__12086)))
{return servant.worker.post_array_buffer.call(null,servant.worker.run_function_name.call(null,event.data));
} else
{throw (new Error(("No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__12086))));
}
}
});
