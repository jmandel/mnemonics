...
{{
var G__16000 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16000;
continue;
}
} else
...
{var pred__16004 = cljs.core._EQ_;var expr__16005 = limit;if(cljs.core.truth_(pred__16004.call(null,(1),expr__16005)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16004.call(null,(2),expr__16005)))
...
var G__16007 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16008 = (limit__$1 - (1));
var G__16009 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__16007;
limit__$1 = G__16008;
parts = G__16009;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___16011 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___16011))
{var replacement_16012 = temp__4124__auto___16011;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_16012)));
} else
{buffer.append(ch);
}
{
var G__16013 = (index + (1));
index = G__16013;
continue;
}
}
