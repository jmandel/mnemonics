...
{return s.replace((new RegExp((function (){var G__27172 = match;return goog.string.regExpEscape(G__27172);
})(),"g")),replacement);
} else
...
{{
var G__27173 = cljs.core.pop(v__$1);
v__$1 = G__27173;
continue;
}
} else
...
{var pred__27181 = cljs.core._EQ_;var expr__27182 = limit;if(cljs.core.truth_((function (){var G__27184 = (1);var G__27185 = expr__27182;return (pred__27181.cljs$core$IFn$_invoke$arity$2 ? pred__27181.cljs$core$IFn$_invoke$arity$2(G__27184,G__27185) : pred__27181.call(null,G__27184,G__27185));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__27186 = (2);var G__27187 = expr__27182;return (pred__27181.cljs$core$IFn$_invoke$arity$2 ? pred__27181.cljs$core$IFn$_invoke$arity$2(G__27186,G__27187) : pred__27181.call(null,G__27186,G__27187));
})()))
...
var G__27191 = s__$1.substring((index + cljs.core.count(m)));
var G__27192 = (limit__$1 - (1));
var G__27193 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__27191;
limit__$1 = G__27192;
parts = G__27193;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__27195 = s;return goog.string.trim(G__27195);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__27197 = s;return goog.string.trimLeft(G__27197);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__27199 = s;return goog.string.trimRight(G__27199);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__27202 = s;return goog.string.isEmptySafe(G__27202);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___27203 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___27203))
{var replacement_27204 = temp__4124__auto___27203;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27204)));
} else
{buffer.append(ch);
}
{
